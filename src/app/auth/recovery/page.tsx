        ...
        <>
            <div className="flex flex-col items-center w-full gap-8">
                ...
                <div className="w-full max-w-lg bg-[#161619] p-8 border border-[#252428] rounded-xl shadow-md">
                    ...
                    <p className="text-[#adaaad] text-xl">Enviaremos um link de redefinição de senha para o seu e-mail.</p>
                    <div className="flex flex-col mt-4">
                        <Input type="email" label="E-MAIL" labelColor="text-[#a1a1aa]" placeholder="email@exemplo.com" containerClassName="w-full" />
                    </div>
                    <div className="flex flex-col mt-4">
                        <ButtonInput label="Enviar Link de Recuperação" labelIcon={<ArrowRight />} containerClassName="w-full h-14 mt-2" />
                    </div>
