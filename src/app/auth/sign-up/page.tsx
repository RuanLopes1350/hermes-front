        ...
        <div className="flex flex-col items-center w-full max-w-screen-xl mx-auto px-6 py-12 gap-12">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div>
                    ...
                    <p className="text-text-secondary text-lg font-medium tracking-tight">Crie sua conta na infraestrutura de e-mails</p>
                </div>
            </div>
            ...
            <div className="w-full max-w-lg bg-surface p-10 border border-border-subtle rounded-3xl shadow-2xl relative overflow-hidden group">
                ...
                <div className="mb-10 text-center">
                    ...
                    <p className="text-text-secondary text-sm font-medium mt-1">Junte-se a centenas de desenvolvedores</p>
                </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-center gap-2 px-1">
                        ...
                        <p className="text-[10px] text-text-secondary font-medium uppercase tracking-wider">Sua senha está protegida por criptografia de ponta</p>
                    </div>
                ...
                <div className="flex items-center gap-4 my-8">
                    ...
                    <p className="text-[10px] font-bold text-text-secondary/50 tracking-widest whitespace-nowrap">OU CADASTRAR COM</p>
                    <div className="flex-1 h-px bg-border-subtle/50"></div>
                </div>
                ...
                <div className="mt-10 text-center border-t border-border-subtle/30 pt-8">
                    <p className="text-text-secondary text-sm font-medium">
                        Já possui uma conta? <Link href="/auth/sign-in" className="text-primary font-bold hover:underline">Fazer login</Link>
                    </p>
                </div>
            </div>
