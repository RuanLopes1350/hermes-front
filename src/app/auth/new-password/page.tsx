        ...
        <>
            <div className="flex flex-col items-center w-full gap-8">
                ...
                <div className="w-full max-w-lg bg-[#161619] p-8 border border-[#252428] rounded-xl shadow-md">
                    <h2 className="text-[#f9f5f8] text-3xl font-bold">Redefinir Senha</h2>
                    <p className="text-[#adaaad] text-xl">Digite sua nova senha abaixo.</p>
                    <div className="flex flex-col mt-4">
                        <Input type="password" label="NOVA SENHA" labelColor="text-[#a1a1aa]" placeholder="••••••••" containerClassName="w-full" />
                    </div>
                    <div className="flex flex-col mt-4">
                        <Input type="password" label="CONFIRMAR NOVA SENHA" labelColor="text-[#a1a1aa]" placeholder="••••••••" containerClassName="w-full" />
                    </div>
                    <div className="flex flex-col mt-4">
                         <ButtonInput label="Redefinir Senha" labelIcon={<ArrowRight />} containerClassName="w-full h-14 mt-2" />
                    </div>
                    <div className="pt-6">
                        <Link href="/auth/sign-in" className="flex flex-row items-center justify-center text-[#adaaad] hover:underline"><ArrowLeft /> Voltar para <span className="text-[#be9dff] hover:underline">Login</span></Link>
                    </div>
                </div>
