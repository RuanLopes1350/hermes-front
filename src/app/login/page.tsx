            ...
            <div className="flex flex-col items-center justify-center min-h-screen gap-8 bg-[#0f0f11]">
                ...
                <div className="w-1/3 bg-[#161619] p-8 border border-[#252428] rounded-sm shadow-md">
                    ...
                    <div className="w-full flex flex-row gap-8">
                        <Button label="GitHub" labelIcon="" containerClassName="w-1/2" />
                        <Button label="Google" labelIcon="" containerClassName="w-1/2" />
                    </div>
                </div>
                <div className="flex flex-col items-center gap-4">
                    <p className="text-[#adaaad]">Não possui uma conta? <a href="#" className="text-[#be9dff] hover:underline">Solicite acesso</a></p>
