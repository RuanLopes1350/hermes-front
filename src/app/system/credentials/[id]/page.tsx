            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <Badge className="bg-primary/10 text-primary border-none text-[10px] font-bold uppercase tracking-widest px-3 py-1">SMTP</Badge>
                    </div>
                    <p className="text-muted-foreground text-sm font-medium italic">Configure os parâmetros de autenticação do seu servidor de e-mail.</p>
                </div>
            </div>
                    ...
                    <Card className="bg-surface border-border-subtle rounded-[40px] overflow-hidden border">
                        ...
                        <CardContent className="p-10 space-y-8">
                            <div className="space-y-3 text-left">
                                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Nome da Credencial</label>
                                <Input 
                                    value={name}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                <div className="md:col-span-3 space-y-3 text-left">
                                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Host SMTP</label>
                                    <Input 
                                ...
                                <div className="space-y-3 text-left">
                                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Porta</label>
                                    <Input 
                                        defaultValue="587"
                                        className="bg-background border-border-subtle rounded-2xl px-6 py-7 text-base focus:border-primary transition-all font-medium italic h-14" 
                                    />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3 text-left">
                                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Usuário / Email</label>
                                    <Input 
                                ...
                                <div className="space-y-3 text-left">
                                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Senha / Token</label>
                            ...
                            <div className="p-6 bg-primary/5 border border-primary/20 rounded-3xl flex items-start gap-4 text-left">
                                ...
                                <div>
                                    <p className="text-xs font-bold text-foreground uppercase tracking-tight mb-1">Dica de Segurança</p>
                ...
                <div className="space-y-8">
                    <Card className="bg-surface border-border-subtle rounded-3xl p-8 space-y-6 text-center border">
                        ...
                        <div className="text-center">
                            <CardTitle className="font-bold text-lg text-foreground uppercase tracking-tighter">Status do Host</CardTitle>
                            <CardDescription className="text-muted-foreground text-xs italic mt-1">Verificado há 10 minutos</CardDescription>
                        </div>
                    ...
                    <Card className="bg-surface border-border-subtle rounded-3xl p-8 space-y-6 border text-left">
                        ...
                        <CardContent className="p-0 space-y-4">
                            <div className="flex justify-between items-center">
                                <p className="text-xs text-muted-foreground italic font-medium">Serviços Vinculados</p>
