			...
			<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
				<div>
					...
					<p className="text-muted-foreground text-sm font-medium italic">
						Configure seus remetentes e obtenha chaves de acesso instantaneamente.
					</p>
				</div>
					...
					<DialogContent className="bg-surface border-border-subtle w-full max-w-2xl rounded-[40px] shadow-2xl p-0 overflow-hidden">
						{!generatedKey ? (
										...
										<div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 text-left">
											...
											<div className="grid grid-cols-1 gap-6 text-left">
												...
												{selectedType === 'plain' ? (
													...
													<div className="space-y-6 text-left">
														<div className="space-y-2">
															<label className="text-[10px] font-bold text-muted-foreground uppercase px-1 font-mono tracking-tighter">
																Google Client ID
															</label>
															<Input
							...
							<div className="p-12 text-center animate-in zoom-in duration-500">
								<div className="bg-success/10 w-20 h-20 rounded-[30px] flex items-center justify-center text-success mx-auto mb-8"></div>
								...
								<div className="bg-background border-2 border-dashed border-success/30 rounded-3xl p-8 mb-8 relative group">
									...
									<Button
										...
										className={
											'absolute -top-4 right-6 px-4 py-2 rounded-xl flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all ' +
					...
					<Table>
						<TableHeader className="bg-background/50">
							<TableRow className="border-b border-border-subtle/30">
								<TableHead className="px-8 py-5 text-[11px] uppercase tracking-wider text-muted-foreground font-bold">
									Identificação
								</TableHead>
								<TableHead className="px-8 py-5 text-[11px] uppercase tracking-wider text-muted-foreground font-bold">
									E-mail
								...
								<TableHead className="px-8 py-5 text-[11px] uppercase tracking-wider text-muted-foreground font-bold text-right">
									Ações
								</TableHead>
							</TableRow>
						</TableHeader>
						<TableBody className="divide-y divide-border-subtle/30">
							{credentials.length === 0 ? (
								<TableRow>
									<TableCell
										colSpan={5}
										className="px-8 py-20 text-center text-muted-foreground italic border-none"
									>
									...
									>
										<TableCell className="px-8 py-6">
											<div className="flex flex-col text-left">
												...
												<span className="text-[9px] text-muted-foreground font-mono opacity-50 uppercase mt-1 italic">
													Service ID: {cred.service_id}
												</span>
											</div>
										</TableCell>
										<TableCell className="px-8 py-6 font-medium text-foreground/80 text-left">
											{cred.login}
										</TableCell>
										<TableCell className="px-8 py-6 text-left">
											{cred.auth_type === 'oauth2' ? (
												<Badge
													variant="outline"
													className="bg-primary/5 text-primary border-primary/20 font-bold text-[10px] uppercase gap-2 px-3 py-1"
												>
												...
												<Badge
													variant="outline"
													className="bg-white/5 text-muted-foreground border-border-subtle font-bold text-[10px] uppercase gap-2 px-3 py-1"
												>
