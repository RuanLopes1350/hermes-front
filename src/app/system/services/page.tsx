    ...
    return (
        <div className="space-y-12 text-left">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight mb-2 uppercase text-foreground">Meus Serviços</h2>
                    ...
                    <DialogContent className="bg-surface border-border-subtle rounded-[40px] max-w-lg p-0 overflow-hidden shadow-2xl">
                        <DialogHeader className="p-10 bg-background/30 text-center border-b border-border-subtle">
                            ...
                            <DialogDescription className="text-muted-foreground text-sm mt-2 italic">
                                {isEditing ? "Altere o nome identificador do seu projeto." : "Dê um nome único para o seu projeto."}
                            </DialogDescription>
                        </DialogHeader>
                        ...
                        <DialogFooter className="p-10 bg-background/30 border-t border-border-subtle flex flex-col gap-4 sm:flex-col">
                            ...
                            >
                                {processing ? <Loader2 className="animate-spin" size={20} /> : (isEditing ? "Salvar Alterações" : "Finalizar Cadastro")}
                            </Button>
                            <Button
                                variant="ghost"
                        ...
                        <Card key={service.id} className="group relative bg-surface border-border-subtle rounded-3xl p-8 hover:border-primary/40 transition-all duration-500 shadow-sm overflow-hidden text-left border">
                            ...
                            <div className="flex justify-between items-start mb-8 relative z-10">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" className="bg-surface border-border-subtle rounded-xl min-w-[160px]">
                                        <DropdownMenuItem onClick={() => handleOpenEdit(service)} className="gap-2 cursor-pointer py-3 text-xs font-bold uppercase tracking-wider">
                            ...
                            <div className="space-y-1 mb-8 relative z-10">
                                <h3 className="text-xl font-bold text-foreground group-hover:text-primary transition-colors truncate" title={service.name}>
                                    {service.name}
                                </h3>
