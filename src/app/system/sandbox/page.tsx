    ...
    return (
        <div className="space-y-12 text-left">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight mb-2 uppercase text-foreground">Sandbox de Testes</h2>
                    <p className="text-muted-foreground text-sm font-medium italic">Simule envios de e-mail e valide suas integrações em tempo real.</p>
                </div>
                
                <Button variant="outline" className="gap-2 uppercase font-bold tracking-widest text-[10px]" onClick={() => setResponse(null)}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className="bg-surface border-border-subtle rounded-[40px] p-10 border text-left">
                    <CardHeader className="p-0 mb-8 flex flex-row items-center gap-3">
                        ...
                        <CardTitle className="text-xl font-bold italic uppercase tracking-tighter text-foreground">Configurar Disparo</CardTitle>
                    </CardHeader>
                    
                    <CardContent className="p-0 space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Serviço de Origem</label>
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Template</label>
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">E-mail de Destino</label>
                            <Input 
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] px-1">Payload de Variáveis (JSON)</label>
                        ...
                        >
                            {sending ? <Loader2 className="animate-spin" size={20} /> : <Play size={20} fill="currentColor" />}
                ...
                <div className="space-y-6 flex flex-col h-full">
                    <Card className="bg-surface border-border-subtle rounded-[40px] border flex-1 flex flex-col overflow-hidden">
                        <CardHeader className="p-8 border-b border-border-subtle bg-background/30 flex flex-row items-center justify-between space-y-0">
                            ...
                            {response && (
                                <Badge className="bg-success/10 text-success border-none text-[9px] font-black uppercase px-2 py-0.5">HTTP 202</Badge>
                            )}
                        </CardHeader>
                    ...
                    <Card className="bg-primary/5 border border-primary/20 rounded-[32px] p-6 border text-left">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <h4 className="font-bold text-sm text-foreground uppercase tracking-tight mb-1">Dica de Integração</h4>
                                <p className="text-muted-foreground text-[11px] italic leading-relaxed">
                                    Você pode usar nosso SDK oficial para Node.js para integrar este disparo em menos de 3 linhas de código.
                                </p>
                            </div>
                        </div>
                    </Card>
