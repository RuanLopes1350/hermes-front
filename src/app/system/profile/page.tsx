    ...
    return (
        <div className="space-y-12 pb-20">
            ...
            <div>
                ...
                <p className="text-text-secondary text-sm">Gerencie suas informações pessoais e preferências de segurança.</p>
            </div>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="relative group cursor-pointer">
                                <div className="h-24 w-24 rounded-2xl border-2 border-border-subtle overflow-hidden bg-background flex items-center justify-center transition-all group-hover:border-primary/50">
                                    <img className="h-full w-full object-cover opacity-80 group-hover:opacity-100 transition-opacity" src="/no-profile-photo.svg" alt="User" />
                                </div>
                            ...
                            <div>
                                ...
                                <p className="text-text-secondary text-xs font-medium uppercase tracking-wider mt-1">Admin da Organização</p>
                                <p className="text-text-secondary/60 text-[10px] mt-2 italic">Formatos: JPG, PNG. Máx: 2MB</p>
                            </div>
                        </div>

                        <div className="flex gap-3">
                            <Button label="Remover" variant="outline" containerClassName="h-10 text-[10px]" />
                            <Button label="Alterar Foto" variant="primary" containerClassName="h-10 text-[10px]" />
                        </div>
                    </div>
            ...
            <section className="space-y-6">
                ...
                <div className="bg-surface border border-border-subtle rounded-3xl p-8 shadow-sm">
                    <div className="mb-10">
                        ...
                        <p className="text-text-secondary text-sm">Mínimo de 8 caracteres com letras, números e símbolos.</p>
                    </div>
                    ...
                    <div className="mt-10 flex justify-end">
                        <Button label="Atualizar Credenciais de Acesso" variant="secondary" containerClassName="md:w-auto px-8" />
                    </div>
                </div>
            </section>
                ...
                <div className="bg-surface border border-border-subtle rounded-3xl p-2 overflow-hidden">
                    <div className="flex flex-row items-center justify-between p-6 hover:bg-white/5 transition-colors rounded-2xl group">
                        <div className="flex flex-col">
                            <h4 className="font-bold text-text-primary group-hover:text-primary transition-colors">Alertas de Segurança</h4>
                            <p className="text-text-secondary text-sm">Notificar sobre logins em novos dispositivos ou falhas de auth.</p>
                        </div>
                        <TickButton />
                    </div>
                    ...
                    <div className="flex flex-row items-center justify-between p-6 hover:bg-white/5 transition-colors rounded-2xl group">
                        <div className="flex flex-col">
                            <h4 className="font-bold text-text-primary group-hover:text-primary transition-colors">Rotação de Chaves</h4>
                            <p className="text-text-secondary text-sm">Avisar quando uma API Key estiver próxima do vencimento.</p>
                        </div>
                        <TickButton />
                    </div>
                </div>
            ...
            <section className="space-y-6">
                ...
                <div className="bg-danger/5 border border-danger/20 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-text-secondary text-sm mt-1">Todos os seus serviços, templates e logs serão apagados. Esta ação é irreversível.</p>
                    </div>
                    <Button label="Excluir Conta" variant="danger" containerClassName="w-full md:w-auto px-10" />
                </div>
            </section>
        </div>
    )
