        ...
        <div className="space-y-10">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 text-left">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm font-medium italic">Monitore o histórico de requisições e atividade da API.</p>
                </div>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-b border-border-subtle bg-background/50 hover:bg-background/50">
                                    <TableHead className="px-8 text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Método / Status</TableHead>
                                    <TableHead className="px-8 text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Endpoint</TableHead>
                                    <TableHead className="px-8 text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em]">Origem</TableHead>
                                    ...
                                    filteredLogs.map((log) => (
                                        <TableRow key={log.id} className="border-b border-border-subtle/50 hover:bg-white/5 transition-colors group">
                                            ...
                                            <TableCell className="px-8 py-6 text-left">
                                                <p className="text-sm font-mono text-foreground truncate max-w-[200px]" title={log.endpoint}>
                                                    {log.endpoint}
                                                </p>
                                                <p className="text-[9px] text-muted-foreground uppercase tracking-tighter">ID: {log.id}</p>
                                            </TableCell>
                                            <TableCell className="px-8 py-6 text-left">
                                                ...
                                                {log.api_key_id && (
                                                    <Badge variant="outline" className="text-[8px] h-4 mt-1 border-primary/20 text-primary">API KEY</Badge>
                                                )}
                                            </TableCell>
                                            <TableCell className="px-8 py-6 text-left">
                    ...
                    <Card className="bg-surface border-border-subtle rounded-3xl p-6">
                        ...
                        <CardContent className="p-0 space-y-4">
                            ...
                            <div className="p-4 bg-background/50 rounded-2xl border border-border-subtle">
                                <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Total de Requisições</p>
