				...
				<aside className="lg:col-span-3 space-y-2">
					<div className="p-4 bg-muted/50 rounded-xl border border-border mb-6">
						...
						<p className="text-xs text-muted-foreground/70">
							Siga o passo a passo para integrar seu sistema com o Hermes.
						</p>
					</div>
						...
						{steps.map((step, idx) => {
							...
							return (
								<button
									...
									className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left transition-all duration-300 group cursor-pointer ${
										isActive
								...
								>
									...
									<StepIcon
										className={`h-4 w-4 shrink-0 transition-transform ${isActive ? 'scale-110 text-primary' : 'text-muted-foreground group-hover:text-foreground'}`}
									/>
							...
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<p className="text-muted-foreground text-base">
										O Hermes utiliza o <strong>Better Auth</strong> para gerenciar sessões, senhas e
										logins sociais com segurança de ponta.
									</p>
								</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-4">
										...
										<div className="flex gap-4">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Cadastre-se usando seu e-mail ou utilize o login social do Google para
													acesso instantâneo.
												</p>
											</div>
										</div>
									...
									<Card className="bg-background border-border shadow-xl max-w-sm mx-auto w-full">
										<CardHeader className="space-y-1 pb-4">
											<CardTitle className="text-lg text-foreground font-bold text-center">
												Criar conta no Hermes
											</CardTitle>
										...
										<CardContent className="space-y-4">
											<div className="space-y-1">
												...
												<div className="bg-muted border border-border rounded-lg p-2.5 text-xs text-muted-foreground">
											...
											<div className="relative flex py-1 items-center">
												...
												<span className="flex-shrink mx-3 text-[10px] text-muted-foreground/50 font-bold uppercase">
													Ou
												</span>
												<div className="flex-grow border-t border-border"></div>
											</div>
											<Button
												variant="outline"
												className="w-full text-xs h-9 cursor-not-allowed flex items-center justify-center gap-2"
											>
												<svg className="h-3.5 w-3.5" viewBox="0 0 24 24">
													<path
														fill="#EA4335"
														d="M12 5.04c1.66 0 3.2.57 4.38 1.69l3.27-3.27C17.67 1.57 15.01 1 12 1 7.24 1 3.2 3.74 1.25 7.74l3.84 2.98C6.03 7.74 8.78 5.04 12 5.04z"
													/>
													<path
														fill="#4285F4"
														d="M23.49 12.27c0-.81-.07-1.59-.2-2.35H12v4.45h6.47c-.28 1.48-1.12 2.73-2.38 3.58l3.69 2.87c2.16-1.99 3.41-4.92 3.41-8.55z"
													/>
													<path
														fill="#FBBC05"
														d="M5.09 14.76c-.24-.72-.38-1.5-.38-2.31s.14-1.59.38-2.31L1.25 7.15C.45 8.79 0 10.62 0 12.5s.45 3.71 1.25 5.35l3.84-3.09z"
													/>
													<path
														fill="#34A853"
														d="M12 23c3.24 0 5.97-1.07 7.96-2.91l-3.69-2.87c-1.02.68-2.33 1.09-3.96 1.09-3.22 0-5.97-2.7-6.91-5.68l-3.84 2.98C3.2 20.26 7.24 23 12 23z"
													/>
												</svg>
						...
						{currentStep === 1 && (
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<h2 className="text-3xl font-extrabold text-foreground tracking-tight">
										Criação de Serviço (Tenant)
									</h2>
									<p className="text-muted-foreground text-base">
										No Hermes, um <strong>Serviço</strong> atua como uma partição lógica (Tenant).
										Todos os e-mails, templates, logs e chaves de API pertencem a um serviço
										específico.
									</p>
								</div>
									...
									<div className="space-y-4">
										<div className="flex gap-4">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Crie múltiplos serviços (ex: <em>Faturamento</em>, <em>Marketing</em>,{' '}
													<em>Suporte</em>). O acesso a um serviço é isolado entre os membros
													convidados.
												</p>
											</div>
										</div>
										...
										<div className="flex gap-4">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Como proprietário do serviço, você pode convidar outros usuários pelo
													e-mail deles para colaborar no mesmo painel de métricas.
												</p>
											</div>
										</div>
									</div>
						...
						{currentStep === 2 && (
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<h2 className="text-3xl font-extrabold text-foreground tracking-tight">
										Provedor de E-mail (SMTP / OAuth2)
									</h2>
									<p className="text-muted-foreground text-base">
										Para enviar e-mails de forma confiável, configure uma{' '}
										<strong>Credencial</strong>. O Hermes suporta autenticação SMTP tradicional por
										senha e autenticação moderna OAuth2 com o Google.
									</p>
								</div>
								...
								{smtpType === 'oauth2' ? (
									<div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
										<div className="space-y-4 text-sm text-muted-foreground">
											...
											<p>
												O Google está descontinuando o uso de senhas tradicionais (menos seguras). O
												OAuth2 autentica o Hermes via tokens de acesso dinâmicos sem expor sua
												senha.
											</p>

											<div className="p-4 bg-muted/50 rounded-xl border border-border space-y-2 text-xs">
												<h4 className="text-foreground font-bold uppercase tracking-wider">
													Como configurar:
												</h4>
												<ol className="list-decimal list-inside space-y-1 text-muted-foreground">
													<li>Crie um projeto no Google Cloud Console.</li>
													<li>
														Configure a tela de Consentimento OAuth e crie uma credencial de ID do
														Cliente.
													</li>
													<li>Adicione a URI de redirecionamento autorizada.</li>
													<li>
														Utilize o fluxo do Hermes para logar em sua conta do Gmail de envio e
														obter o <strong>Refresh Token</strong>.
													</li>
												</ol>
											</div>
										</div>
										...
										<Card className="bg-background border-border p-5 shadow-sm space-y-3">
											...
											<div className="space-y-1">
												...
												<input
													type="text"
													readOnly
													value="1069303710668-cniot9...apps.googleusercontent.com"
													className="w-full bg-muted border border-border rounded-lg p-2.5 text-xs text-muted-foreground outline-none"
												/>
											</div>
											<div className="space-y-1">
												<label className="text-[10px] font-bold uppercase text-muted-foreground">
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-2">
										<div className="space-y-4 text-sm text-muted-foreground">
											<h3 className="text-foreground font-bold text-base">
												Configuração SMTP Comum
											</h3>
											<p>
												Ideal para servidores de e-mail próprios, SendGrid, Mailgun, Amazon SES ou
												servidores internos de hospedagem corporativa.
											</p>
											...
											<div className="p-4 bg-muted/50 rounded-xl border border-border space-y-2 text-xs">
												...
												<p className="text-muted-foreground">
													As senhas (<code className="text-primary">passkey</code>) e segredos
													armazenados são criptografados no banco de dados com algoritmo AES-256-CBC
													de padrão industrial, impedindo vazamentos mesmo com acesso físico às
													tabelas.
												</p>
											</div>
										</div>
										...
										<Card className="bg-background border-border p-5 shadow-sm space-y-3">
											...
											<div className="grid grid-cols-2 gap-4">
												...
												<div className="space-y-1">
													...
													<div className="bg-success/10 border border-success/20 rounded-lg p-2.5 text-xs text-success font-bold">
														Ativo (SSL)
													</div>
												</div>
											</div>
						...
						{currentStep === 3 && (
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<h2 className="text-3xl font-extrabold text-foreground tracking-tight">
										Templates Dinâmicos com MJML e Handlebars
									</h2>
									<p className="text-muted-foreground text-base">
										Crie e-mails responsivos que abrem perfeitamente no celular e desktop usando a
										sintaxe robusta do <strong>MJML</strong> aliada às variáveis dinâmicas do{' '}
								...
								<div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch pt-2">
									...
									<div className="xl:col-span-7 flex flex-col rounded-xl border border-border overflow-hidden bg-background font-mono text-xs shadow-sm min-h-[300px]">
										<div className="bg-muted px-4 py-2 border-b border-border flex justify-between items-center">
											...
											<Badge className="bg-primary/10 text-primary border border-primary/20 font-sans">
												AOT Compilado
											</Badge>
										</div>
...
14: </mjml>`}
									...
									<div className="xl:col-span-5 space-y-4 flex flex-col justify-center text-sm text-muted-foreground">
										<div className="flex gap-3 items-start">
											...
											<p>
												<strong className="text-foreground">Compilação AOT (Ahead-Of-Time)</strong>:
												O Hermes compila o código MJML para HTML puro no momento em que você o
												salva, garantindo que o envio de e-mails pelo worker BullMQ seja até 50
												vezes mais rápido por não sobrecarregar a CPU.
											</p>
										</div>
										<div className="flex gap-3 items-start">
											<div className="h-2 w-2 rounded-full bg-primary mt-2 shrink-0"></div>
											<p>
												<strong className="text-foreground">Fácil injeção</strong>: Chaves
												Handlebars como{' '}
												<code className="text-primary text-xs">{'{{nome_usuario}}'}</code> são
												mantidas no HTML compilado para substituição dinâmica rápida em tempo de
												envio.
											</p>
										</div>
										<div className="flex gap-3 items-start">
											<div className="h-2 w-2 rounded-full bg-primary mt-2 shrink-0"></div>
											<p>
												<strong className="text-foreground">Sanitização automática</strong>: O
												Hermes higieniza HTML perigoso nas variáveis enviadas para evitar injeções
												de scripts maliciosos (XSS) no leitor do e-mail.
											</p>
										</div>
									</div>
								</div>
						...
						{currentStep === 4 && (
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<h2 className="text-3xl font-extrabold text-foreground tracking-tight">
										Geração de Chaves de API Seguras
									</h2>
									<p className="text-muted-foreground text-base">
										Para integrar seus sistemas, você deve gerar uma <strong>API Key</strong>{' '}
										associada a um Serviço e a uma Credencial de e-mail.
									</p>
								</div>
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center pt-4">
									<div className="space-y-4 text-sm text-muted-foreground">
										...
										<p>
											Cada API Key gerada é atrelada a uma credencial específica de SMTP. Quando seu
											sistema faz um envio usando essa chave, o Hermes já sabe por qual servidor
											deve rotear o e-mail.
										</p>
										<p>
											O Hermes exibe a chave apenas <strong>uma única vez</strong> no momento da
											criação. O banco de dados armazena apenas um hash irreversível da chave,
									...
									<Card className="bg-background border-border p-6 shadow-sm space-y-4">
										<div className="space-y-1">
											...
											<div className="bg-muted border border-border rounded-lg p-2.5 text-xs text-foreground">
												E-commerce API
											</div>
										</div>
										<div className="space-y-1">
										...
										<div className="pt-2">
											{generatedKey ? (
												<div className="space-y-2">
													<label className="text-[10px] font-bold uppercase text-success">
														Sua API Key (Copie agora!)
													</label>
						...
						{currentStep === 5 && (
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<h2 className="text-3xl font-extrabold text-foreground tracking-tight">
										Utilização Prática: Requests &amp; Responses
									</h2>
									<p className="text-muted-foreground text-base">
										Faça chamadas HTTP REST para enviar e-mails de forma simples ou em lote (bulk).
										Insira sua chave no header{' '}
										<code className="text-primary text-sm">x-api-key</code>.
									</p>
								</div>
...
response = requests.post(url, headers=headers, json=data)`}
									...
									<div className="xl:col-span-5 flex flex-col rounded-xl border border-border overflow-hidden bg-background font-mono text-xs shadow-sm min-h-[300px]">
										<div className="bg-muted px-4 py-2 border-b border-border flex justify-between items-center">
											...
											<Badge className="bg-success/10 text-success border border-success/20 font-sans">
												202 Accepted
											</Badge>
										</div>
						...
						{currentStep === 6 && (
							<div className="space-y-6 animate-in fade-in duration-500">
								<div className="space-y-2">
									...
									<p className="text-muted-foreground text-base">
										O Hermes possui documentação automática Swagger integrada que permite testar
										requisições em tempo real no ambiente do desenvolvedor.
									</p>
								</div>
									...
									<div className="space-y-4">
										<div className="flex gap-4">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Acesse <code className="text-primary text-xs">/api/docs</code> no servidor
													backend para abrir o console Swagger UI. Todos os schemas e tipos de
										...
										<div className="flex gap-4">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Cole sua API Key gerada na autenticação global do Swagger e teste os
													envios diretamente da página da documentação, sem escrever nenhuma linha
													de código.
												</p>
											</div>
										</div>
										...
										<div className="p-4 space-y-3 font-sans text-xs">
											...
											<div className="space-y-2">
												<div className="bg-success/10 border border-success/20 rounded-md p-2 flex items-center gap-3">
													<Badge className="bg-success text-success-foreground hover:bg-success text-[9px] px-1 h-5 cursor-default">
														POST
													</Badge>
												...
												<div className="bg-primary/10 border border-primary/20 rounded-md p-2 flex items-center gap-3 opacity-60">
													<Badge className="bg-primary text-primary-foreground hover:bg-primary text-[9px] px-1 h-5 cursor-default">
														GET
													</Badge>
													<span className="font-mono text-foreground font-semibold text-[10px]">
														/api/services
