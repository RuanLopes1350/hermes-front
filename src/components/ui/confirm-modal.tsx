      ...
      <DialogContent className="bg-surface border-border-subtle rounded-[32px] max-w-md p-0 overflow-hidden shadow-2xl">
        ...
        <DialogFooter className="p-8 bg-background/30 flex flex-col gap-3 sm:flex-col">
          <Button
            ...
            disabled={loading}
            className={cn(
              "w-full py-6 rounded-xl text-xs font-black uppercase tracking-[0.2em] shadow-lg transition-all",
              variant === "danger" 
          ...
          <Button
            ...
            onClick={onClose}
            disabled={loading}
            className="w-full py-2 text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground"
          >
            {cancelText}
          </Button>
        </DialogFooter>
